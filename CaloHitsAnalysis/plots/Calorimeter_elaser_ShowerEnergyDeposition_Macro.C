...
void Calorimeter_elaser_ShowerEnergyDeposition_Macro()
{
  SetLuxeStyle();
...
leg->AddEntry((TObject*)0, "w/o beam bkg", "");
  ...
  gPad->Print("Calorimeter_elaser_ShowerEnergyDeposition.png");
  gPad->Print("Calorimeter_elaser_ShowerEnergyDeposition.C");
...
#ifndef __CINT__
int main() { 
  Calorimeter_elaser_ShowerEnergyDeposition_Macro();
