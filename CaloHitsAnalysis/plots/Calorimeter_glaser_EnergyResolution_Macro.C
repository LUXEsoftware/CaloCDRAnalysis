...
void Calorimeter_glaser_EnergyResolution_Macro()
{
  SetLuxeStyle();
...
leg->AddEntry(Fun2,reso,"l");
  ...
  gPad->Print("Calorimeter_glaser_EnergyResolution.png");
  gPad->Print("Calorimeter_glaser_EnergyResolution.C");
...
#ifndef __CINT__
int main() { 
  Calorimeter_glaser_EnergyResolution_Macro();
