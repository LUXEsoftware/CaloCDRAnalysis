...
void Calorimeter_Elaser_position_SumEnergyPerBX_Macro()
{
  SetLuxeStyle();
...
//  TFile* FileSig=TFile::Open("e_laser_w0_8000nm_phase1_nbx941_final.root");
  ...
  gPad->Print("Calorimeter_Elaser_position_SumEnergyPerBX.png");
  gPad->Print("Calorimeter_Elaser_position_SumEnergyPerBX.C");
...
#ifndef __CINT__
int main() { 
  Calorimeter_Elaser_position_SumEnergyPerBX_Macro();
