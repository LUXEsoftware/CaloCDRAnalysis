void Calorimeter_glaser_EnergyResolution()
{
//=========Macro generated from canvas: c1/c1
//=========  (Mon Jan 25 21:35:34 2021) by ROOT version 6.22/06
   ...
   Fun21002->SetChisquare(13.64953);
   Fun21002->SetNDF(10);
   ...
   Fun21002->SetParameter(0,0.1900665);
   Fun21002->SetParError(0,0.001855316);
   ...
   Graph_Graph11003->SetMinimum(0.04701709);
   Graph_Graph11003->SetMaximum(0.1412849);
